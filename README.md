...
![Language Proficiency](https://quickchart.io/chart?c={type:'bar',data:{labels:['C++','HTML','CSS','JavaScript','PHP'],datasets:[{label:'Proficiency',data:[75,85,80,60,80]}]},options:{scales:{y:{beginAtZero:true}}}})
