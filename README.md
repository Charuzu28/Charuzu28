...
![Language Proficiency](https://quickchart.io/chart?c={type:'bar',data:{labels:['C++','HTML','CSS','JavaScript','PHP'],datasets:[{label:'Proficiency',data:[90,85,80,75,70]}]},options:{scales:{y:{beginAtZero:true}}}})
